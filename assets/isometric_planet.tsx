...
<tileset version="1.9" tiledversion="1.9.2" name="planet" tilewidth="32" tileheight="32" tilecount="7" columns="7">
 <editorsettings>
  <export target="planet.tileset" format="isometric-toolset-tileset"/>
 </editorsettings>
 <properties>
  <property name="source" value="planet_tileset.png"/>
 </properties>
 ...
 <tile id="0">
  <objectgroup draworder="index" id="2">
   ...
   <object id="6" class="collision" x="15.8125" y="0.3125">
    <polygon points="0,0 -15.25,7.625 -0.25,15.9375 15.375,7.625"/>
   </object>
  </objectgroup>
 </tile>
 <tile id="1">
